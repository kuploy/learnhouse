...
<Callout type="info">
**Using a board in a live class?** On the lesson, pick this board once from the
**▾** beside **🎥 Go live** — it's remembered, so you and your students join with
it in one click (no copying ids). See
