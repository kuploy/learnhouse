...
<Callout type="info">
**Using a board in a live class?** Just click **🎥 Go live** on the lesson and
pick this board from the menu — no copying ids. See
[Live Classrooms → Attach a Board](/platform/live-classrooms#attach-a-board-video-beside-shared-work)
for the full flow (and the shareable `&board=` link for students).
</Callout>
